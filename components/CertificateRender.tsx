...
export const CertificateRender: React.FC<Props> = ({ data, isPreview = false }) => {
  ...
  const ROW_11_Y = START_Y + ROW_STEP * 10; // 860
  ...
  return (
    ...
    >
      ...
      <div className="absolute z-[10]" style={{ top: `${ROW_4_Y}px`, left: `${VALUE_X}px`, width: '500px', height: '34px' }}>
        <span className="font-serif font-bold text-black block" style={{ fontSize: FONT_VALUE, lineHeight: LEADING_NORMAL }}>
          {data.ncqaNumber}
        </span>
      </div>
      ...
      <div className="absolute z-[10]" style={{ top: `${ROW_6_Y}px`, left: `${VALUE_X}px`, width: '500px', height: '34px' }}>
        <span className="font-serif font-bold text-black block" style={{ fontSize: FONT_VALUE, lineHeight: LEADING_NORMAL }}>
          {data.issueDate}
        </span>
      </div>
      ...
      <div className="absolute z-[10]" style={{ top: `${ROW_10_Y}px`, left: `${VALUE_X}px`, width: '500px', height: '34px' }}>
        <span className="font-serif font-bold text-black block" style={{ fontSize: FONT_VALUE, lineHeight: LEADING_NORMAL }}>
          {data.expirationDate || 'N/A'}
        </span>
      </div>

      {/* Row 11: Verified Body (Black) */}
      <div className="absolute z-[10]" style={{ top: `${ROW_11_Y}px`, left: `${LABEL_X}px` }}>
        <span className="font-serif font-bold text-gray-600 block leading-none" style={{ fontSize: FONT_LABEL }}>Verified Body :</span>
      </div>
      <div className="absolute z-[10]" style={{ top: `${ROW_11_Y}px`, left: `${VALUE_X}px`, width: MAX_TEXT_WIDTH, height: '34px' }}>
